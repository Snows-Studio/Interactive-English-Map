// Function to format numbers into more readable strings
function formatNumber(number) {
    if (number >= 1000000) {
        return (number / 1000000).toFixed(1) + ' million';  // Convert to millions
    } else if (number >= 1000) {
        return (number / 1000).toFixed(0) + 'K';  // Convert to thousands
    }
    return number.toLocaleString();  // For numbers below 1000, add commas
}
